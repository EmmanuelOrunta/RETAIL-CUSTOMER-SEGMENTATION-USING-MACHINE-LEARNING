...
# This is done to make sure that each of the features are the same scale level for fair comparison.. This is to make sure one feature doesn't dominate the others in the clustering due to its size
...
for k in range(1, 10):
    ...
    # Low inertia → better grouping but too low = overfitting
